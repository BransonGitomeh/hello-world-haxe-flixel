...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("MyFirstHaxeFlixelProject", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("MyFirstHaxeFlixelProject", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "MyFirstHaxeFlixelProject";
		app.meta["name"] = "MyFirstHaxeFlixelProject";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: false,
			title: "MyFirstHaxeFlixelProject",
			width: 640,
			x: null,
			y: null,
		};
